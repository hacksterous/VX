#########################################################
# apbf
# calls pybf backend for math ops
#########################################################
...
class mpap ():
	...
	def sci(self):
		#print ("sci:----called sci self is ", repr(self), "self.Sign = ", 
		#	self.Sign, "self.Mantissa = ", self.Mantissa, "self.lenStrMantissa = ", self.lenStrMantissa)
		man = str(self.Mantissa)
		expo = self.Exponent
		#print ("sci:--------man is ", man)
		#print ("sci:--------expo is ", expo)
		strMantissa = str(man).replace('-', '')
		#print ("sci:--------strMantissa is ", strMantissa)
		if self.Exponent <= 0:
			#print ("self.Exponent <= 0")
			...
			if self.Exponent % 3 != 0:
				...
				multfac = 0
			#print ("1. self.sgn() =", self.sgn())
			#print ("1. strMantissa = ", strMantissa)
			#print ("1. multfac = ", multfac)
		...
		#print ("sci:--------returning with man is ", man)
		#print ("sci:--------returning with expo is ", expo)
		return man, expo
